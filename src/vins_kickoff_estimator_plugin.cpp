...
void VinsKickoff::initialize([[maybe_unused]] const rclcpp::Node::SharedPtr &node,
  ...
  ph->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("mrs_uav_managers") + "/config/public/uav_manager.yaml");
  ...
  sh_controller_diag_         = mrs_lib::SubscriberHandler<mrs_msgs::msg::ControllerDiagnostics>(shopts, "controller_diagnostics_in");
  sh_estimation_manager_diag_ = mrs_lib::SubscriberHandler<mrs_msgs::msg::EstimationDiagnostics>(shopts, "diagnostics_out");
  ...
  sh_control_reference_       = mrs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, "control_reference_in");

  /*//{ initialize service clients */

  // | ------------- service clients initialization ------------- |
  srvch_failsafe_ = mrs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "failsafe_out");
  srvch_switch_estimator_ = mrs_lib::ServiceClientHandler<mrs_msgs::srv::String>(node_, "change_estimator_in");
...
/*//{ setUavState() */
bool VinsKickoff::setUavState([[maybe_unused]] const mrs_msgs::msg::UavState &uav_state) {
